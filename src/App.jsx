...
const BLUEPRINTS = [
  {
    ...
    act:{id:"kf5",name:"Void Kelp Grove",lv:80,xp:110,t:45,out:[{id:"kelp",q:12},{id:"void_essence",q:1}]},
  ...
  },
  {
    ...
    act:{id:"cd5",name:"Void Crystal Resonance",lv:95,xp:125,t:45,inp:[{id:"abyss_crystal",q:3}],out:[{id:"void_essence",q:2},{id:"abyss_crystal",q:5}]},
  ...
  },
  {
    ...
    act:{id:"bs5",name:"Ancient Healing Formula",lv:70,xp:116,t:60,inp:[{id:"alien_bio_tissue",q:1},{id:"void_pearl",q:1}],out:[{id:"pressure_tonic",q:3},{id:"bio_stim",q:1}]},
    source:"Lost Research Facility",
  },
  {
...
const SKILLS=[
  ...
  {id:"kelp_farming",name:"Cultivation",icon:"🌿",color:"#00c285",cat:"gather",acts:[
    {id:"kf1",name:"Reef Kelp Bed",      lv:1,  xp:5,t:20, out:[{id:"kelp",q:1}]},
    {id:"kf2",name:"Coral Fronds",       lv:20, xp:15,t:25, out:[{id:"soft_coral",q:1}]},
    {id:"kf3",name:"Mushroom Patch",     lv:40, xp:35,t:30, out:[{id:"sea_mushrooms",q:1}]},
    {id:"kf4",name:"Tidal Sap Harvest",  lv:60, xp:65,t:35, out:[{id:"tide_sap",q:1}]},
    {id:"kf5",name:"Spore Bed",          lv:85, xp:110,t:45, out:[{id:"kelp_spores",q:1}]},
    {id:"kf6",name:"Void Kelp Abyss",    lv:110,xp:200,t:60, out:[{id:"void_kelp",q:1}]}]},
  ...
  {id:"deep_mining",name:"Deep Sea Mining",icon:"⛏️",color:"#7b61ff",cat:"gather",acts:[
    {id:"dm1",name:"Reef Sandstone",     lv:1,  xp:5,t:20, out:[{id:"trench_stone",q:1}]},
    {id:"dm2",name:"Shell Bed",          lv:20, xp:15,t:25, out:[{id:"shell_fragments",q:1}]},
    {id:"dm3",name:"Salt Crystal Vein",  lv:40, xp:35,t:30, out:[{id:"salt_crystals",q:1}]},
    {id:"dm4",name:"Thermal Ore Seam",   lv:60, xp:65,t:35, out:[{id:"thermal_ore",q:1}]},
    {id:"dm5",name:"Magma Shard Seam",   lv:85, xp:110,t:45, out:[{id:"magma_shard",q:1}]},
    {id:"dm6",name:"Obsidian Depths",    lv:110,xp:200,t:60, out:[{id:"obsidian_ore",q:1}]}]},
  ...
  {id:"bioluminescent_fishing",name:"Abyss Fishing",icon:"🎣",color:"#00d4ff",cat:"gather",acts:[
    {id:"bf1",name:"Reef Pool Fishing",  lv:1,  xp:5,t:20, out:[{id:"glowfish",q:1}]},
    {id:"bf2",name:"Scale Harvest",      lv:20, xp:15,t:25, out:[{id:"phosphor_scales",q:1}]},
    {id:"bf3",name:"Roe Collection",     lv:40, xp:35,t:30, out:[{id:"deepsea_roe",q:1}]},
    {id:"bf4",name:"Fiber Net Trawl",    lv:60, xp:65,t:35, out:[{id:"ocean_fiber",q:1}]},
    {id:"bf5",name:"Void Fin Hunt",      lv:85, xp:110,t:45, out:[{id:"void_fin",q:1}]},
    {id:"bf6",name:"Abyss Trawling",     lv:110,xp:200,t:60, out:[{id:"alien_bio_tissue",q:1}]}]},
  ...
  {id:"crystal_diving",name:"Crystal Diving",icon:"💎",color:"#a78bfa",cat:"gather",acts:[
    {id:"cd1",name:"Shallows Crystals",  lv:1,  xp:6,t:20, out:[{id:"abyss_crystal",q:1}]},
    {id:"cd2",name:"Quartz Shelf",       lv:20, xp:18,t:25, out:[{id:"raw_quartz",q:1}]},
    {id:"cd3",name:"Silt Crystal Cave",  lv:40, xp:40,t:30, out:[{id:"silt_crystal",q:1}]},
    {id:"cd4",name:"Ether Dust Pocket",  lv:60, xp:75,t:35, out:[{id:"ether_dust",q:1}]},
    {id:"cd5",name:"Void Pearl Dive",    lv:85, xp:125,t:45, out:[{id:"void_pearl",q:1}]},
    {id:"cd6",name:"Void Crystal Core",  lv:110,xp:225,t:60, out:[{id:"void_essence",q:1}]}]},
  ...
  {id:"trench_exploration",name:"Trench Exploration",icon:"🗺️",color:"#38bdf8",cat:"gather",acts:[
    ...
    {id:"te5",name:"Abyss Silt Trench",  lv:85, xp:110,t:45, out:[{id:"abyss_silt",q:1}]},
    {id:"te6",name:"Lost Relic Vault",   lv:110,xp:200,t:60, out:[{id:"ancient_relic",q:1}]}]},
  {id:"coral_engineering",name:"Coral Engineering",icon:"🔧",color:"#ffd60a",cat:"prod",acts:[
    {id:"ce1",name:"Coral Blocks",lv:1,xp:8,t:20,inp:[{id:"soft_coral",q:3}],out:[{id:"coral_blocks",q:1}]},
    {id:"ce2",name:"Reinforced Alloy",lv:10,xp:14,t:22,inp:[{id:"shell_fragments",q:5},{id:"trench_stone",q:3}],out:[{id:"reinforced_alloy",q:1}]},
    {id:"ce3",name:"Pressure Glass",lv:20,xp:30,t:35,inp:[{id:"salt_crystals",q:4},{id:"thermal_ore",q:2}],out:[{id:"pressure_glass",q:1}]},
    {id:"ce4",name:"Coral Helm",lv:5,xp:36,t:35,inp:[{id:"coral_blocks",q:8},{id:"shell_fragments",q:5}],out:[{id:"coral_helm",q:1}]},
    {id:"ce5",name:"Shell Shield",lv:12,xp:80,t:55,inp:[{id:"coral_blocks",q:12},{id:"reinforced_alloy",q:3}],out:[{id:"shell_shield",q:1}]},
    {id:"ce6",name:"Coral Suit",lv:15,xp:118,t:60,inp:[{id:"coral_blocks",q:15},{id:"reinforced_alloy",q:5}],out:[{id:"coral_suit",q:1}]}]},
  {id:"bio_refining",name:"Bio Refining",icon:"🧪",color:"#00ffb3",cat:"prod",acts:[
    {id:"br1",name:"Biofuel",lv:1,xp:8,t:20,inp:[{id:"kelp",q:5}],out:[{id:"biofuel",q:1}]},
    {id:"br2",name:"Enzyme Compound",lv:10,xp:8,t:20,inp:[{id:"glowfish",q:3}],out:[{id:"enzyme_compound",q:1}]},
    {id:"br3",name:"Luminescent Gel",lv:20,xp:15,t:22,inp:[{id:"glowfish",q:4},{id:"sea_mushrooms",q:2}],out:[{id:"luminescent_gel",q:1}]}]},
  {id:"pressure_engineering",name:"Pressure Engineering",icon:"⚡",color:"#ff6b35",cat:"prod",acts:[
    {id:"pe1",name:"Basic Harpoon",lv:1,xp:11,t:22,inp:[{id:"trench_stone",q:5},{id:"ocean_fiber",q:3}],out:[{id:"basic_harpoon",q:1}]},
    {id:"pe2",name:"Pressure Helm",lv:10,xp:80,t:55,inp:[{id:"pressure_glass",q:2},{id:"reinforced_alloy",q:4}],out:[{id:"pressure_helm",q:1}]},
    {id:"pe3",name:"Pressure Suit",lv:20,xp:148,t:60,inp:[{id:"pressure_glass",q:3},{id:"reinforced_alloy",q:8}],out:[{id:"pressure_suit",q:1}]},
    {id:"pe4",name:"Pulse Harpoon",lv:15,xp:56,t:50,inp:[{id:"pressure_glass",q:2},{id:"enzyme_compound",q:2}],out:[{id:"pulse_harpoon",q:1}]},
    {id:"pe5",name:"Depth Gloves",lv:5,xp:10,t:22,inp:[{id:"ocean_fiber",q:6}],out:[{id:"depth_gloves",q:1}]},
    {id:"pe6",name:"Pressure Boots",lv:8,xp:19,t:22,inp:[{id:"ocean_fiber",q:8},{id:"coral_blocks",q:2}],out:[{id:"pressure_boots",q:1}]}]},
  {id:"bio_synthesis",name:"Bio Synthesis",icon:"🧬",color:"#c084fc",cat:"prod",acts:[
    {id:"bs1",name:"Healing Serum",lv:1,xp:8,t:20,inp:[{id:"sea_mushrooms",q:3}],out:[{id:"healing_serum",q:1}]},
    {id:"bs2",name:"Kelp Broth",lv:10,xp:10,t:22,inp:[{id:"kelp",q:4},{id:"enzyme_compound",q:1}],out:[{id:"kelp_broth",q:1}]},
    {id:"bs3",name:"Pressure Tonic",lv:25,xp:45,t:42,inp:[{id:"enzyme_compound",q:2},{id:"abyss_crystal",q:1}],out:[{id:"pressure_tonic",q:1}]},
    {id:"bs4",name:"Bio Stim",lv:15,xp:46,t:42,inp:[{id:"luminescent_gel",q:2},{id:"sea_mushrooms",q:3}],out:[{id:"bio_stim",q:1}]}]},
  {id:"artifact_research",name:"Artifact Research",icon:"🔬",color:"#ff9500",cat:"prod",acts:[
    {id:"ar1",name:"Process Ore Sample",lv:1,xp:13,t:22,inp:[{id:"trench_stone",q:8}],out:[{id:"drone_processor",q:1}]},
    {id:"ar2",name:"Crystal Refinement",lv:15,xp:36,t:35,inp:[{id:"abyss_crystal",q:2}],out:[{id:"pressure_reactor",q:1}]}]},
  // --- New production skills ---
  {id:"submersible_fabrication",name:"Submersible Fabrication",icon:"🚢",color:"#06b6d4",cat:"prod",acts:[
    {id:"sf1",name:"Basic Frame",lv:1,xp:45,t:42,inp:[{id:"coral_blocks",q:10},{id:"ocean_fiber",q:5}],out:[{id:"void_ring",q:1}]},
    {id:"sf2",name:"Shock Harpoon",lv:20,xp:106,t:60,inp:[{id:"pressure_glass",q:4},{id:"enzyme_compound",q:3}],out:[{id:"shock_harpoon",q:1}]},
    {id:"sf3",name:"Thermal Lance",lv:40,xp:170,t:60,inp:[{id:"thermal_ore",q:8},{id:"abyss_crystal",q:2}],out:[{id:"thermal_lance",q:1}]},
    {id:"sf4",name:"Abyss Armor",lv:55,xp:108,t:60,inp:[{id:"reinforced_alloy",q:15},{id:"pressure_glass",q:6},{id:"abyss_crystal",q:3}],out:[{id:"abyss_armor",q:1}]}]},
  {id:"drone_construction",name:"Drone Construction",icon:"🤖",color:"#f472b6",cat:"prod",acts:[
    {id:"dc1",name:"Basic Processor",lv:1,xp:74,t:55,inp:[{id:"trench_stone",q:5},{id:"thermal_ore",q:3}],out:[{id:"drone_processor",q:1}]},
    {id:"dc2",name:"Pressure Reactor",lv:15,xp:54,t:50,inp:[{id:"pressure_glass",q:3},{id:"enzyme_compound",q:2}],out:[{id:"pressure_reactor",q:1}]},
    {id:"dc3",name:"Depth Pendant",lv:10,xp:100,t:60,inp:[{id:"abyss_crystal",q:1},{id:"ocean_fiber",q:4}],out:[{id:"depth_pendant",q:1}]},
    {id:"dc4",name:"Bioluminescent Brew",lv:25,xp:132,t:60,inp:[{id:"luminescent_gel",q:2},{id:"glowfish",q:4}],out:[{id:"bioluminescent_drink",q:1}]}]},
  {id:"ocean_architecture",name:"Ocean Architecture",icon:"🏗️",color:"#34d399",cat:"prod",acts:[
    {id:"oa1",name:"Thermal Steel",lv:10,xp:32,t:35,inp:[{id:"thermal_ore",q:4},{id:"salt_crystals",q:3}],out:[{id:"reinforced_alloy",q:1}]},
    {id:"oa2",name:"Void Elixir",lv:30,xp:132,t:60,inp:[{id:"abyss_crystal",q:2},{id:"enzyme_compound",q:2}],out:[{id:"void_elixir",q:1}]},
    {id:"oa3",name:"Deep Extract",lv:20,xp:212,t:60,inp:[{id:"sea_mushrooms",q:5},{id:"glowfish",q:3}],out:[{id:"deep_extract",q:1}]},
    {id:"oa4",name:"Bio Stim Mk2",lv:45,xp:56,t:50,inp:[{id:"luminescent_gel",q:3},{id:"pressure_tonic",q:1}],out:[{id:"bio_stim",q:1}]}]},
  {id:"energy_systems",name:"Energy Systems",icon:"⚡",color:"#facc15",cat:"prod",acts:[
    {id:"es1",name:"Biofuel Refined",lv:5,xp:10,t:22,inp:[{id:"kelp",q:8},{id:"sea_mushrooms",q:2}],out:[{id:"biofuel",q:1}]},
    {id:"es2",name:"Pressure Conduit",lv:20,xp:66,t:55,inp:[{id:"pressure_glass",q:2},{id:"reinforced_alloy",q:3}],out:[{id:"pressure_reactor",q:1},{id:"drone_processor",q:1}]},
    {id:"es3",name:"Kelp Broth Premium",lv:15,xp:37,t:35,inp:[{id:"kelp",q:6},{id:"enzyme_compound",q:2}],out:[{id:"kelp_broth",q:1}]},
    {id:"es4",name:"Pressure Tonic Mk2",lv:40,xp:80,t:55,inp:[{id:"abyss_crystal",q:1},{id:"enzyme_compound",q:3},{id:"luminescent_gel",q:2}],out:[{id:"pressure_tonic",q:1}]}]},
  // ── Utility Skills ──
  {id:"navigation",name:"Navigation",icon:"🧭",color:"#38bdf8",cat:"utility",acts:[
    {id:"nv1",name:"Chart Reef Currents",lv:1,xp:20,t:28,out:[{id:"nav_beacon",q:1}],util:{type:"speed",val:0.05},desc:"Map reef currents. +5% gather speed this session."},
    {id:"nv2",name:"Map Twilight Lanes",lv:15,xp:45,t:42,inp:[{id:"nav_beacon",q:1}],out:[{id:"ocean_chart",q:1}],util:{type:"speed",val:0.10},desc:"Chart twilight lanes. +10% gather speed."},
    {id:"nv3",name:"Deep Trench Routes",lv:35,xp:85,t:55,inp:[{id:"ocean_chart",q:1}],out:[{id:"void_map",q:1}],util:{type:"speed",val:0.15},desc:"Map deep trench routes. +15% gather speed."},
    {id:"nv4",name:"Void Cartography",lv:60,xp:160,t:55,inp:[{id:"void_map",q:1},{id:"abyss_crystal",q:2}],out:[{id:"void_map",q:2}],util:{type:"speed",val:0.20},desc:"Chart void passages. +20% gather speed permanently."}]},
  {id:"scanning",name:"Scanning",icon:"📡",color:"#22d3ee",cat:"utility",acts:[
    {id:"sc1",name:"Bio Scan",lv:1,xp:20,t:28,out:[{id:"scan_report",q:1}],util:{type:"rare",val:0.03},desc:"Scan for lifeforms. +3% discovery chance."},
    {id:"sc2",name:"Deep Resonance Scan",lv:20,xp:50,t:42,inp:[{id:"scan_report",q:1}],out:[{id:"resonance_crystal",q:1}],util:{type:"rare",val:0.05},desc:"Detect rare nodes. +5% rare drop chance."},
    {id:"sc3",name:"Void Signal Trace",lv:40,xp:100,t:55,inp:[{id:"resonance_crystal",q:1},{id:"drone_processor",q:1}],out:[{id:"resonance_crystal",q:2}],util:{type:"rare",val:0.08},desc:"Trace void signals. +8% rare drops."},
    {id:"sc4",name:"Ancient Frequency Lock",lv:65,xp:200,t:60,inp:[{id:"resonance_crystal",q:2},{id:"ancient_processor",q:1}],out:[{id:"ancient_data_chip",q:1}],util:{type:"rare",val:0.12},desc:"Lock ancient frequencies. +12% rare drops."}]},
  {id:"archaeology",name:"Archaeology",icon:"🏺",color:"#fb923c",cat:"utility",acts:[
    {id:"ac1",name:"Surface Excavation",lv:1,xp:25,t:28,out:[{id:"relic_shard",q:1}],util:{type:"rp",val:5},desc:"Excavate reef surface. Gain RP and relics."},
    {id:"ac2",name:"Ancient Wreck Dive",lv:20,xp:60,t:50,inp:[{id:"relic_shard",q:2}],out:[{id:"ancient_relic",q:1}],util:{type:"rp",val:15},desc:"Dive ancient wrecks. Recover artifact fragments."},
    {id:"ac3",name:"Relic Reconstruction",lv:40,xp:120,t:55,inp:[{id:"ancient_relic",q:2},{id:"abyss_crystal",q:1}],out:[{id:"ancient_processor",q:1}],util:{type:"rp",val:30},desc:"Reconstruct ancient tech. +30 RP per action."},
    {id:"ac4",name:"Ancient Core Extraction",lv:70,xp:230,t:60,inp:[{id:"ancient_processor",q:1},{id:"thermal_core",q:1}],out:[{id:"ancient_data_chip",q:2}],util:{type:"rp",val:80},desc:"Extract ancient cores. Massive RP gain."}]},
  {id:"ocean_cartography",name:"Ocean Cartography",icon:"🗺️",color:"#a78bfa",cat:"utility",acts:[
    {id:"oc1",name:"Reef Survey",lv:1,xp:22,t:28,out:[{id:"ocean_chart",q:1}],util:{type:"yield",val:0.05},desc:"Survey reef zones. +5% resource yield."},
    {id:"oc2",name:"Abyss Mapping",lv:25,xp:55,t:42,inp:[{id:"ocean_chart",q:1}],out:[{id:"ocean_chart",q:2}],util:{type:"yield",val:0.10},desc:"Map abyssal regions. +10% resource yield."},
    {id:"oc3",name:"Void Region Chart",lv:50,xp:110,t:55,inp:[{id:"ocean_chart",q:2},{id:"void_pearl",q:1}],out:[{id:"void_map",q:1}],util:{type:"yield",val:0.15},desc:"Chart void regions. +15% resource yield."},
    {id:"oc4",name:"Complete Ocean Atlas",lv:80,xp:240,t:60,inp:[{id:"void_map",q:2},{id:"ancient_relic",q:1}],out:[{id:"void_map",q:3}],util:{type:"yield",val:0.25},desc:"Complete the ocean atlas. +25% all yield."}]},
  {id:"logistics",name:"Logistics",icon:"📦",color:"#34d399",cat:"utility",acts:[
    {id:"lg1",name:"Supply Cache",lv:1,xp:10,t:22,inp:[{id:"kelp",q:5},{id:"sea_mushrooms",q:3}],out:[{id:"supply_crate",q:1}],util:{type:"gold",val:10},desc:"Pack supply cache. Creates healing crates."},
    {id:"lg2",name:"Trade Bundle",lv:15,xp:20,t:28,inp:[{id:"kelp",q:8},{id:"glowfish",q:5}],out:[{id:"supply_crate",q:2}],util:{type:"gold",val:25},desc:"Bundle for trade. +25 bonus credits."},
    {id:"lg3",name:"Efficiency Protocol",lv:35,xp:78,t:55,inp:[{id:"drone_processor",q:1},{id:"supply_crate",q:1}],out:[{id:"supply_crate",q:3}],util:{type:"gold",val:50},desc:"Optimize logistics. +50 bonus credits per action."},
    {id:"lg4",name:"Deep Supply Network",lv:60,xp:148,t:60,inp:[{id:"ancient_data_chip",q:1},{id:"supply_crate",q:2}],out:[{id:"supply_crate",q:5}],util:{type:"gold",val:120},desc:"Build deep supply network. Major credit bonus."}]},
  // ── Endgame / Rare Crafting ──
  {id:"relic_forging",name:"Relic Forging",icon:"⚗️",color:"#e11d48",cat:"prod",acts:[
    {id:"rf1",name:"Void Pearl Extract",lv:30,xp:70,t:55,inp:[{id:"abyss_crystal",q:3},{id:"luminescent_gel",q:4}],out:[{id:"void_pearl",q:1}]},
    {id:"rf2",name:"Black Coral Harvest",lv:45,xp:84,t:55,inp:[{id:"coral_blocks",q:15},{id:"thermal_ore",q:5}],out:[{id:"black_coral",q:1}]},
    {id:"rf3",name:"Thermal Core Forge",lv:55,xp:181,t:60,inp:[{id:"thermal_ore",q:15},{id:"pressure_glass",q:5},{id:"abyss_crystal",q:2}],out:[{id:"thermal_core",q:1}]},
    {id:"rf4",name:"Alien Tissue Culture",lv:65,xp:241,t:60,inp:[{id:"enzyme_compound",q:8},{id:"luminescent_gel",q:6},{id:"void_pearl",q:1}],out:[{id:"alien_bio_tissue",q:1}]},
    {id:"rf5",name:"Leviathan Spear",lv:70,xp:320,t:60,inp:[{id:"leviathan_bone",q:3},{id:"thermal_core",q:2},{id:"ancient_processor",q:1}],out:[{id:"leviathan_spear",q:1}]},
    {id:"rf6",name:"Leviathan Armor",lv:75,xp:350,t:60,inp:[{id:"leviathan_bone",q:5},{id:"alien_bio_tissue",q:2},{id:"black_coral",q:3}],out:[{id:"leviathan_armor",q:1}]},
    {id:"rf7",name:"Ancient Helm",lv:60,xp:428,t:60,inp:[{id:"ancient_relic",q:3},{id:"void_pearl",q:2},{id:"reinforced_alloy",q:10}],out:[{id:"ancient_helm",q:1}]},
    {id:"rf8",name:"Void Amulet",lv:50,xp:218,t:60,inp:[{id:"void_pearl",q:2},{id:"abyss_crystal",q:4},{id:"black_coral",q:2}],out:[{id:"void_amulet",q:1}]}]},

  // ── Cultivation Gear ──
  {id:"gear_crafting",name:"Gear Crafting",icon:"🔧",color:"#f59e0b",cat:"prod",acts:[
    // ── Cultivation ──
    {id:"cg1",gearCat:"cultivation",name:"Kelp Rake",         lv:5, xp:30,t:28, inp:[{id:"kelp",q:10},{id:"ocean_fiber",q:5}],                               out:[{id:"kelp_rake",q:1}]},
    {id:"cg2",gearCat:"cultivation",name:"Tide Harvester",    lv:25,xp:60,t:42, inp:[{id:"soft_coral",q:8},{id:"tide_sap",q:4},{id:"ocean_fiber",q:8}],      out:[{id:"tide_harvester",q:1}]},
    {id:"cg3",gearCat:"cultivation",name:"Spore Collector",   lv:55,xp:110,t:55, inp:[{id:"kelp_spores",q:6},{id:"tide_sap",q:8},{id:"void_pearl",q:1}],      out:[{id:"spore_collector",q:1}]},
    {id:"cg4",gearCat:"cultivation",name:"Void Tendril",      lv:85,xp:200,t:60,inp:[{id:"void_kelp",q:4},{id:"kelp_spores",q:10},{id:"void_essence",q:1}],  out:[{id:"void_tendril",q:1}]},
    {id:"cg5",gearCat:"cultivation",name:"Kelp Hood",         lv:55,xp:90,t:42, inp:[{id:"kelp",q:20},{id:"soft_coral",q:8},{id:"ocean_fiber",q:10}],         out:[{id:"kelp_hood",q:1}]},
    {id:"cg6",gearCat:"cultivation",name:"Kelp Suit",         lv:80,xp:160,t:55, inp:[{id:"tide_sap",q:6},{id:"soft_coral",q:15},{id:"kelp",q:25},{id:"ocean_fiber",q:12}], out:[{id:"kelp_suit",q:1}]},
    {id:"cg7",gearCat:"cultivation",name:"Kelp Gloves",       lv:15,xp:30,t:22, inp:[{id:"kelp",q:10},{id:"ocean_fiber",q:6}],                               out:[{id:"kelp_gloves",q:1}]},
    {id:"cg8",gearCat:"cultivation",name:"Kelp Boots",        lv:35,xp:55,t:28, inp:[{id:"kelp",q:12},{id:"sea_mushrooms",q:6},{id:"ocean_fiber",q:5}],      out:[{id:"kelp_boots",q:1}]},
    // ── Mining ──
    {id:"mg1",gearCat:"mining",name:"Reef Pick",              lv:5, xp:30,t:28, inp:[{id:"trench_stone",q:12},{id:"shell_fragments",q:6}],                   out:[{id:"reef_pick",q:1}]},
    {id:"mg2",gearCat:"mining",name:"Brine Drill",            lv:25,xp:60,t:42, inp:[{id:"salt_crystals",q:8},{id:"shell_fragments",q:10},{id:"reinforced_alloy",q:3}], out:[{id:"brine_drill",q:1}]},
    {id:"mg3",gearCat:"mining",name:"Magma Borer",            lv:55,xp:110,t:55, inp:[{id:"magma_shard",q:5},{id:"thermal_ore",q:10},{id:"reinforced_alloy",q:6}],       out:[{id:"magma_borer",q:1}]},
    {id:"mg4",gearCat:"mining",name:"Obsidian Crusher",       lv:85,xp:200,t:60,inp:[{id:"obsidian_ore",q:4},{id:"magma_shard",q:8},{id:"thermal_core",q:2}],           out:[{id:"obsidian_crusher",q:1}]},
    {id:"mg5",gearCat:"mining",name:"Ore Helm",               lv:55,xp:90,t:42, inp:[{id:"trench_stone",q:25},{id:"shell_fragments",q:10},{id:"salt_crystals",q:6}], out:[{id:"ore_helm",q:1}]},
    {id:"mg6",gearCat:"mining",name:"Ore Vest",               lv:80,xp:160,t:55, inp:[{id:"shell_fragments",q:20},{id:"salt_crystals",q:12},{id:"thermal_ore",q:8},{id:"reinforced_alloy",q:6}], out:[{id:"ore_vest",q:1}]},
    {id:"mg7",gearCat:"mining",name:"Ore Gauntlets",          lv:15,xp:30,t:22, inp:[{id:"trench_stone",q:15},{id:"shell_fragments",q:8}],                   out:[{id:"ore_gauntlets",q:1}]},
    {id:"mg8",gearCat:"mining",name:"Ore Treads",             lv:35,xp:55,t:28, inp:[{id:"trench_stone",q:18},{id:"shell_fragments",q:8},{id:"salt_crystals",q:5}], out:[{id:"ore_treads",q:1}]},
    // ── Fishing ──
    {id:"fg1",gearCat:"fishing",name:"Glow Rod",              lv:5, xp:30,t:28, inp:[{id:"glowfish",q:8},{id:"ocean_fiber",q:6}],                            out:[{id:"glow_rod",q:1}]},
    {id:"fg2",gearCat:"fishing",name:"Phosphor Net",          lv:25,xp:60,t:42, inp:[{id:"phosphor_scales",q:8},{id:"deepsea_roe",q:4},{id:"ocean_fiber",q:10}], out:[{id:"phosphor_net",q:1}]},
    {id:"fg3",gearCat:"fishing",name:"Void Lure",             lv:55,xp:110,t:55, inp:[{id:"void_fin",q:4},{id:"deepsea_roe",q:8},{id:"void_pearl",q:1}],      out:[{id:"void_lure",q:1}]},
    {id:"fg4",gearCat:"fishing",name:"Abyss Trawl",           lv:85,xp:200,t:60,inp:[{id:"alien_bio_tissue",q:3},{id:"void_fin",q:6},{id:"void_essence",q:1}], out:[{id:"abyss_trawl",q:1}]},
    {id:"fg5",gearCat:"fishing",name:"Scale Mask",            lv:55,xp:90,t:42, inp:[{id:"phosphor_scales",q:14},{id:"glowfish",q:10},{id:"deepsea_roe",q:5}], out:[{id:"scale_mask",q:1}]},
    {id:"fg6",gearCat:"fishing",name:"Scale Suit",            lv:80,xp:160,t:55, inp:[{id:"phosphor_scales",q:20},{id:"deepsea_roe",q:12},{id:"ocean_fiber",q:15},{id:"glowfish",q:8}], out:[{id:"scale_suit",q:1}]},
    {id:"fg7",gearCat:"fishing",name:"Scale Fins",            lv:15,xp:30,t:22, inp:[{id:"glowfish",q:12},{id:"ocean_fiber",q:8}],                           out:[{id:"scale_fins",q:1}]},
    {id:"fg8",gearCat:"fishing",name:"Scale Boots",           lv:35,xp:55,t:28, inp:[{id:"phosphor_scales",q:12},{id:"glowfish",q:8},{id:"ocean_fiber",q:8}], out:[{id:"scale_boots",q:1}]},
    // ── Crystal ──
    {id:"xg1",gearCat:"crystal",name:"Quartz Chisel",         lv:10,xp:30,t:28, inp:[{id:"abyss_crystal",q:4},{id:"raw_quartz",q:6}],                        out:[{id:"quartz_chisel",q:1}]},
    {id:"xg2",gearCat:"crystal",name:"Silt Probe",            lv:30,xp:60,t:42, inp:[{id:"raw_quartz",q:8},{id:"silt_crystal",q:5},{id:"abyss_crystal",q:3}], out:[{id:"silt_probe",q:1}]},
    {id:"xg3",gearCat:"crystal",name:"Ether Lens",            lv:60,xp:110,t:55, inp:[{id:"silt_crystal",q:6},{id:"ether_dust",q:6},{id:"void_pearl",q:2}],   out:[{id:"ether_lens",q:1}]},
    {id:"xg4",gearCat:"crystal",name:"Void Resonator",        lv:90,xp:200,t:60,inp:[{id:"void_pearl",q:3},{id:"ether_dust",q:10},{id:"void_essence",q:2}],  out:[{id:"void_resonator",q:1}]},
    {id:"xg5",gearCat:"crystal",name:"Crystal Visor",         lv:65,xp:90,t:42, inp:[{id:"abyss_crystal",q:8},{id:"raw_quartz",q:10},{id:"silt_crystal",q:4}], out:[{id:"crystal_visor",q:1}]},
    {id:"xg6",gearCat:"crystal",name:"Crystal Suit",          lv:90,xp:160,t:55, inp:[{id:"silt_crystal",q:12},{id:"ether_dust",q:6},{id:"abyss_crystal",q:12},{id:"raw_quartz",q:10}], out:[{id:"crystal_suit",q:1}]},
    ...
    {id:"tg5",gearCat:"trench",name:"Explorer Helm",          lv:65,xp:90,t:42, inp:[{id:"deep_moss",q:14},{id:"ocean_fiber",q:10},{id:"sediment_core",q:5}], out:[{id:"explorer_helm",q:1}]},
    {id:"tg6",gearCat:"trench",name:"Explorer Suit",          lv:90,xp:160,t:55, inp:[{id:"sediment_core",q:12},{id:"ancient_fragment",q:6},{id:"deep_moss",q:15},{id:"ocean_fiber",q:15}], out:[{id:"explorer_suit",q:1}]},
    {id:"tg7",gearCat:"trench",name:"Explorer Gloves",        lv:25,xp:30,t:22, inp:[{id:"deep_moss",q:10},{id:"ocean_fiber",q:8}],                          out:[{id:"explorer_gloves",q:1}]},
    {id:"tg8",gearCat:"trench",name:"Explorer Boots",         lv:45,xp:55,t:28, inp:[{id:"ocean_fiber",q:12},{id:"deep_moss",q:8},{id:"sediment_core",q:3}],  out:[{id:"explorer_boots",q:1}]}]},
];
