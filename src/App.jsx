...
const SKILLS=[
  ...
  {id:"logistics",name:"Logistics",icon:"📦",color:"#34d399",cat:"utility",acts:[
    ...
    {id:"lg2",name:"Trade Bundle",lv:15,xp:45,t:6,inp:[{id:"kelp",q:8},{id:"glowfish",q:5}],out:[{id:"supply_crate",q:2}],util:{type:"gold",val:25},desc:"Bundle for trade. +25 bonus credits."},
  ...
  {id:"relic_forging",name:"Relic Forging",icon:"⚗️",color:"#e11d48",cat:"prod",acts:[
    ...
    {id:"rf2",name:"Black Coral Harvest",lv:45,xp:120,t:9,inp:[{id:"coral_blocks",q:15},{id:"thermal_ore",q:5}],out:[{id:"black_coral",q:1}]},
  ...
  {id:"gear_crafting",name:"Gear Crafting",icon:"🔧",color:"#f59e0b",cat:"prod",acts:[
    // ── Cultivation ──
    {id:"cg1",gearCat:"cultivation",name:"Kelp Rake",         lv:5, xp:20, t:4, inp:[{id:"kelp",q:10},{id:"ocean_fiber",q:5}],                               out:[{id:"kelp_rake",q:1}]},
    {id:"cg2",gearCat:"cultivation",name:"Tide Harvester",    lv:25,xp:55, t:6, inp:[{id:"soft_coral",q:8},{id:"tide_sap",q:4},{id:"ocean_fiber",q:8}],      out:[{id:"tide_harvester",q:1}]},
    {id:"cg3",gearCat:"cultivation",name:"Spore Collector",   lv:55,xp:110,t:8, inp:[{id:"kelp_spores",q:6},{id:"tide_sap",q:8},{id:"void_pearl",q:1}],      out:[{id:"spore_collector",q:1}]},
    {id:"cg4",gearCat:"cultivation",name:"Void Tendril",      lv:85,xp:200,t:10,inp:[{id:"void_kelp",q:4},{id:"kelp_spores",q:10},{id:"void_essence",q:1}],  out:[{id:"void_tendril",q:1}]},
    {id:"cg5",gearCat:"cultivation",name:"Kelp Hood",         lv:55,xp:50, t:5, inp:[{id:"kelp",q:20},{id:"soft_coral",q:8},{id:"ocean_fiber",q:10}],         out:[{id:"kelp_hood",q:1}]},
    {id:"cg6",gearCat:"cultivation",name:"Kelp Suit",         lv:80,xp:90, t:8, inp:[{id:"tide_sap",q:6},{id:"soft_coral",q:15},{id:"kelp",q:25},{id:"ocean_fiber",q:12}], out:[{id:"kelp_suit",q:1}]},
    {id:"cg7",gearCat:"cultivation",name:"Kelp Gloves",       lv:15,xp:25, t:4, inp:[{id:"kelp",q:10},{id:"ocean_fiber",q:6}],                               out:[{id:"kelp_gloves",q:1}]},
    {id:"cg8",gearCat:"cultivation",name:"Kelp Boots",        lv:35,xp:35, t:4, inp:[{id:"kelp",q:12},{id:"sea_mushrooms",q:6},{id:"ocean_fiber",q:5}],      out:[{id:"kelp_boots",q:1}]},
    // ── Mining ──
    {id:"mg1",gearCat:"mining",name:"Reef Pick",              lv:5, xp:20, t:4, inp:[{id:"trench_stone",q:12},{id:"shell_fragments",q:6}],                   out:[{id:"reef_pick",q:1}]},
    {id:"mg2",gearCat:"mining",name:"Brine Drill",            lv:25,xp:55, t:6, inp:[{id:"salt_crystals",q:8},{id:"shell_fragments",q:10},{id:"reinforced_alloy",q:3}], out:[{id:"brine_drill",q:1}]},
    {id:"mg3",gearCat:"mining",name:"Magma Borer",            lv:55,xp:110,t:8, inp:[{id:"magma_shard",q:5},{id:"thermal_ore",q:10},{id:"reinforced_alloy",q:6}],       out:[{id:"magma_borer",q:1}]},
    {id:"mg4",gearCat:"mining",name:"Obsidian Crusher",       lv:85,xp:200,t:10,inp:[{id:"obsidian_ore",q:4},{id:"magma_shard",q:8},{id:"thermal_core",q:2}],           out:[{id:"obsidian_crusher",q:1}]},
    {id:"mg5",gearCat:"mining",name:"Ore Helm",               lv:55,xp:55, t:6, inp:[{id:"trench_stone",q:25},{id:"shell_fragments",q:10},{id:"salt_crystals",q:6}], out:[{id:"ore_helm",q:1}]},
    {id:"mg6",gearCat:"mining",name:"Ore Vest",               lv:80,xp:95, t:8, inp:[{id:"shell_fragments",q:20},{id:"salt_crystals",q:12},{id:"thermal_ore",q:8},{id:"reinforced_alloy",q:6}], out:[{id:"ore_vest",q:1}]},
    {id:"mg7",gearCat:"mining",name:"Ore Gauntlets",          lv:15,xp:25, t:4, inp:[{id:"trench_stone",q:15},{id:"shell_fragments",q:8}],                   out:[{id:"ore_gauntlets",q:1}]},
    {id:"mg8",gearCat:"mining",name:"Ore Treads",             lv:35,xp:35, t:5, inp:[{id:"trench_stone",q:18},{id:"shell_fragments",q:8},{id:"salt_crystals",q:5}], out:[{id:"ore_treads",q:1}]},
    // ── Fishing ──
    {id:"fg1",gearCat:"fishing",name:"Glow Rod",              lv:5, xp:20, t:4, inp:[{id:"glowfish",q:8},{id:"ocean_fiber",q:6}],                            out:[{id:"glow_rod",q:1}]},
    {id:"fg2",gearCat:"fishing",name:"Phosphor Net",          lv:25,xp:55, t:6, inp:[{id:"phosphor_scales",q:8},{id:"deepsea_roe",q:4},{id:"ocean_fiber",q:10}], out:[{id:"phosphor_net",q:1}]},
    {id:"fg3",gearCat:"fishing",name:"Void Lure",             lv:55,xp:110,t:8, inp:[{id:"void_fin",q:4},{id:"deepsea_roe",q:8},{id:"void_pearl",q:1}],      out:[{id:"void_lure",q:1}]},
    {id:"fg4",gearCat:"fishing",name:"Abyss Trawl",           lv:85,xp:200,t:10,inp:[{id:"alien_bio_tissue",q:3},{id:"void_fin",q:6},{id:"void_essence",q:1}], out:[{id:"abyss_trawl",q:1}]},
    {id:"fg5",gearCat:"fishing",name:"Scale Mask",            lv:55,xp:55, t:6, inp:[{id:"phosphor_scales",q:14},{id:"glowfish",q:10},{id:"deepsea_roe",q:5}], out:[{id:"scale_mask",q:1}]},
    {id:"fg6",gearCat:"fishing",name:"Scale Suit",            lv:80,xp:95, t:8, inp:[{id:"phosphor_scales",q:20},{id:"deepsea_roe",q:12},{id:"ocean_fiber",q:15},{id:"glowfish",q:8}], out:[{id:"scale_suit",q:1}]},
    {id:"fg7",gearCat:"fishing",name:"Scale Fins",            lv:15,xp:25, t:4, inp:[{id:"glowfish",q:12},{id:"ocean_fiber",q:8}],                           out:[{id:"scale_fins",q:1}]},
    {id:"fg8",gearCat:"fishing",name:"Scale Boots",           lv:35,xp:35, t:5, inp:[{id:"phosphor_scales",q:12},{id:"glowfish",q:8},{id:"ocean_fiber",q:8}], out:[{id:"scale_boots",q:1}]},
    // ── Crystal ──
    {id:"xg1",gearCat:"crystal",name:"Quartz Chisel",         lv:10,xp:25, t:4, inp:[{id:"abyss_crystal",q:4},{id:"raw_quartz",q:6}],                        out:[{id:"quartz_chisel",q:1}]},
    {id:"xg2",gearCat:"crystal",name:"Silt Probe",            lv:30,xp:60, t:6, inp:[{id:"raw_quartz",q:8},{id:"silt_crystal",q:5},{id:"abyss_crystal",q:3}], out:[{id:"silt_probe",q:1}]},
    {id:"xg3",gearCat:"crystal",name:"Ether Lens",            lv:60,xp:120,t:8, inp:[{id:"silt_crystal",q:6},{id:"ether_dust",q:6},{id:"void_pearl",q:2}],   out:[{id:"ether_lens",q:1}]},
    {id:"xg4",gearCat:"crystal",name:"Void Resonator",        lv:90,xp:220,t:10,inp:[{id:"void_pearl",q:3},{id:"ether_dust",q:10},{id:"void_essence",q:2}],  out:[{id:"void_resonator",q:1}]},
    {id:"xg5",gearCat:"crystal",name:"Crystal Visor",         lv:65,xp:60, t:6, inp:[{id:"abyss_crystal",q:8},{id:"raw_quartz",q:10},{id:"silt_crystal",q:4}], out:[{id:"crystal_visor",q:1}]},
    {id:"xg6",gearCat:"crystal",name:"Crystal Suit",          lv:90,xp:110,t:8, inp:[{id:"silt_crystal",q:12},{id:"ether_dust",q:6},{id:"abyss_crystal",q:12},{id:"raw_quartz",q:10}], out:[{id:"crystal_suit",q:1}]},
    {id:"xg7",gearCat:"crystal",name:"Crystal Gloves",        lv:25,xp:30, t:4, inp:[{id:"abyss_crystal",q:6},{id:"raw_quartz",q:6}],                        out:[{id:"crystal_gloves",q:1}]},
    {id:"xg8",gearCat:"crystal",name:"Crystal Fins",          lv:45,xp:40, t:5, inp:[{id:"raw_quartz",q:8},{id:"abyss_crystal",q:6},{id:"silt_crystal",q:3}], out:[{id:"crystal_fins",q:1}]},
    // ── Trench ──
    {id:"tg1",gearCat:"trench",name:"Sediment Brush",         lv:10,xp:25, t:4, inp:[{id:"ocean_fiber",q:8},{id:"deep_moss",q:6}],                           out:[{id:"sediment_brush",q:1}]},
    {id:"tg2",gearCat:"trench",name:"Ruin Scanner",           lv:30,xp:60, t:6, inp:[{id:"sediment_core",q:5},{id:"deep_moss",q:8},{id:"trench_stone",q:10}], out:[{id:"ruin_scanner",q:1}]},
    {id:"tg3",gearCat:"trench",name:"Fragment Extractor",     lv:60,xp:120,t:8, inp:[{id:"ancient_fragment",q:4},{id:"sediment_core",q:8},{id:"abyss_crystal",q:2}], out:[{id:"fragment_extractor",q:1}]},
    {id:"tg4",gearCat:"trench",name:"Ancient Probe",          lv:90,xp:220,t:10,inp:[{id:"abyss_silt",q:5},{id:"ancient_fragment",q:8},{id:"void_essence",q:1}], out:[{id:"ancient_probe",q:1}]},
    {id:"tg5",gearCat:"trench",name:"Explorer Helm",          lv:65,xp:60, t:6, inp:[{id:"deep_moss",q:14},{id:"ocean_fiber",q:10},{id:"sediment_core",q:5}], out:[{id:"explorer_helm",q:1}]},
    {id:"tg6",gearCat:"trench",name:"Explorer Suit",          lv:90,xp:110,t:8, inp:[{id:"sediment_core",q:12},{id:"ancient_fragment",q:6},{id:"deep_moss",q:15},{id:"ocean_fiber",q:15}], out:[{id:"explorer_suit",q:1}]},
    {id:"tg7",gearCat:"trench",name:"Explorer Gloves",        lv:25,xp:30, t:4, inp:[{id:"deep_moss",q:10},{id:"ocean_fiber",q:8}],                          out:[{id:"explorer_gloves",q:1}]},
    {id:"tg8",gearCat:"trench",name:"Explorer Boots",         lv:45,xp:40, t:5, inp:[{id:"ocean_fiber",q:12},{id:"deep_moss",q:8},{id:"sediment_core",q:3}],  out:[{id:"explorer_boots",q:1}]}]},
];
