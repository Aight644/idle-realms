...
const SKILLS=[
  ...
  {id:"gear_crafting",name:"Gear Crafting",icon:"🛠️",color:"#f59e0b",cat:"prod",acts:[
        {id:"gc_r1",name:"Braid Fiber",lv:1, xp:12,t:8, inp:[{id:"sea_fiber",q:4}],out:[{id:"fiber_cord",q:1}]},
    {id:"gc_r2",name:"Weave Scales",lv:5, xp:18,t:10,inp:[{id:"phosphor_scales",q:4},{id:"sea_fiber",q:2}],out:[{id:"scale_weave",q:1}]},
    {id:"gc_r3",name:"Treat Kelp",lv:15,xp:24,t:12,inp:[{id:"kelp",q:6},{id:"shell_fragments",q:3}],out:[{id:"fiber_cord",q:2}]},
    {id:"gc_r4",name:"Cure Ocean Fiber",lv:30,xp:38,t:14,inp:[{id:"ocean_fiber",q:4},{id:"salt_crystals",q:2}],out:[{id:"scale_weave",q:2}]},
    {id:"gc_r5",name:"Spin Void Thread",lv:55,xp:75,t:20,inp:[{id:"void_fin",q:3},{id:"ocean_fiber",q:4}],out:[{id:"void_thread",q:1}]},
