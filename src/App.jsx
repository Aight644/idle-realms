...
const SKILLS=[
  ...
  {id:"fabrication",name:"Fabrication",icon:"🔧",color:"#ffd60a",cat:"prod",acts:[
    ...
    {id:"oa1",name:"Smelt Thermal Steel",lv:15,xp:37,t:14,inp:[{id:"thermal_ore",q:4},{id:"salt_crystals",q:3}],out:[{id:"thermal_steel",q:1}]},
    ...
    {id:"es2",name:"Pressure Conduit",lv:40,xp:76,t:19,inp:[{id:"pressure_glass",q:2},{id:"reinforced_alloy",q:3}],out:[{id:"pressure_conduit",q:1},{id:"drone_processor",q:1}]}]},
  {id:"bio_lab",name:"Bio Lab",icon:"🧪",color:"#00ffb3",cat:"prod",acts:[
    ...
    {id:"oa4",name:"Bio Stim Mk2",lv:50,xp:95, t:21,inp:[{id:"luminescent_gel",q:3},{id:"pressure_tonic",q:1}],out:[{id:"bio_stim",q:2}]}]},
  ...
  {id:"gear_crafting",name:"Gear Crafting",icon:"🛠️",color:"#f59e0b",cat:"prod",acts:[
    ...
    {id:"gc_r5",name:"Weave Scale Plate x2",lv:35,xp:45,t:15,inp:[{id:"phosphor_scales",q:6},{id:"scale_weave",q:2}],             out:[{id:"scale_plate",q:2}]},
    {id:"gc_r6",name:"Cure Fiber x2",       lv:45,xp:58,t:17,inp:[{id:"ocean_fiber",q:6},{id:"salt_crystals",q:3}],                out:[{id:"cured_fiber",q:2}]},
